...
set(SUNSHINE_TARGET_FILES
        ...
        "${CMAKE_SOURCE_DIR}/src/performance_monitor.h"
...
list(APPEND SUNSHINE_DEFINITIONS APOLLO_TRACY_AVAILABLE=$<BOOL:${APOLLO_TRACY_AVAILABLE}>)
list(APPEND SUNSHINE_DEFINITIONS APOLLO_OPENTELEMETRY_AVAILABLE=$<BOOL:${APOLLO_OPENTELEMETRY_AVAILABLE}>)
list(APPEND SUNSHINE_DEFINITIONS APOLLO_MSQUIC_AVAILABLE=$<BOOL:${APOLLO_MSQUIC_AVAILABLE}>)
list(APPEND SUNSHINE_DEFINITIONS APOLLO_WEB_EXPERIMENTS=$<BOOL:${APOLLO_ENABLE_WEB_EXPERIMENTS}>)
